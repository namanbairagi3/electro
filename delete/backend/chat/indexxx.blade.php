...
<!-- Mirrored from connectme-html.themeyn.com/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 30 Jul 2024 08:05:43 GMT -->
<!-- Added by HTTrack -->
                    ...
                    <ul class="tyn-appbar-nav tyn-appbar-nav-start">
                        ...
                        <li class="tyn-appbar-item d-none d-sm-inline-flex">
                            <a class="tyn-appbar-link position-relative" href="chat-bot-s2.html">
                                ...
                                <div class="badge bg-primary position-absolute rounded-pill top-0 end-0 mt-n1 me-n1">2
                                </div>
                                    ...
                                    <ul class="tyn-media-list gap gap-3">
                                        ...
                                        <li>
                                            <div class="tyn-media-group align-items-start">
                                                ...
                                                <div class="tyn-media-col">
                                                    <div class="tyn-media-row">
                                                        <span class="message"><strong>Thomas Poulain</strong> Added
                                                            You</span>
                                                    </div>
                                                    <div class="tyn-media-row has-dot-sap">
                                    ...
                                    <ul class="tyn-list-links nav nav-tabs border-0">
                                        <li>
                                            <button class="nav-link active" data-bs-toggle="tab"
                                                ...
                                                <!-- chat-square-text -->
                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                                    fill="currentColor" class="bi bi-chat-square-text"
                                                    viewBox="0 0 16 16">
                                                    <path
                                        ...
                                        <li>
                                            <button class="nav-link" data-bs-toggle="tab"
                                                data-bs-target="#active-contacts">
                                                <!-- person-check -->
                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                ...
                                <li class="tyn-aside-item js-toggle-main">
                                    <div class="tyn-media-group">
                                        ...
                                        <div class="tyn-media-col">
                                            ...
                                            <div class="tyn-media-row has-dot-sap">
                                                <p class="content">Same here. I&#39;ve been trying to keep myself
                                                    occupied</p>
                                                <span class="meta">2 days</span>
                                            </div>
                                        </div>
                ...
                <div class="tyn-chat-body js-scroll-to-end" id="tynChatBody">
                    <div class="tyn-reply" id="tynReply">
                                        ...
                                        <a href="#" class="tyn-call">
                                            <div class="tyn-media-group">
                                                <div class="tyn-media tyn-size-lg text-bg-light">
                                                    <!-- person-video3 -->
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                                        fill="currentColor" class="bi bi-person-video3"
                                                        viewBox="0 0 16 16">
                                                        <path
                        ...
                        <div class="tyn-reply-item outgoing">
                            <div class="tyn-reply-group">
                                <div class="tyn-reply-bubble">
                                    <div class="tyn-reply-text"> Do you know which App or feature it will require to set
                                        up. </div><!-- tyn-reply-text -->
                                    <ul class="tyn-reply-tools">
                                        <li>
                                            <button class="btn btn-icon btn-sm btn-transparent btn-pill">
                                                <!-- emoji-smile-fill -->
                                ...
                                <div class="tyn-reply-bubble">
                                    <div class="tyn-reply-link has-thumb">
                                        <div class="tyn-reply-link-thumb">
                                            <a href="#">
                                                <h6 class="tyn-reply-link-title">Digital Marketing Guide line for
                                                    dummies</h6>
                                                <img src="images/avatar/4.jpg" alt="">
                                            </a>
                                        </div>
                ...
                <div class="tyn-chat-content-aside" id="tynChatAside" data-simplebar>
                    ...
                    <div class="tyn-aside-row">
                        <ul class="nav nav-btns nav-btns-stretch nav-btns-light">
                            ...
                            <li class="nav-item">
                                <button class="nav-link" data-bs-toggle="tab" data-bs-target="#chat-media"
                                    type="button">
                                    <!-- images -->
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                        ...
                        <div class="tab-pane" id="chat-media" tabindex="0">
                            <div class="tyn-aside-row py-0">
                                <ul class="nav nav-tabs nav-tabs-line">
                                    ...
                                    <li class="nav-item">
                                        <button class="nav-link" data-bs-toggle="tab"
                                            data-bs-target="#chat-media-videos" type="button"> Videos </button>
                                    </li>
                                    <li class="nav-item">
                                                ...
                                                <a href="#" class="tyn-links">
                                                    <div class="tyn-media-group">
                                                        ...
                                                        <div class="tyn-media-col">
                                                            ...
                                                            <div class="anchor">
                                                                https://www.envato.com/blog/digital-marketing-guide/
                                                            </div>
                                                        </div>
                                                    </div>
                                                </a>
                                                ...
                                                <a href="#" class="tyn-file">
                                                    <div class="tyn-media-group">
                                                        ...
                                                        <div class="tyn-media-col">
                                                            ...
                                                            <div class="meta">Frank will no longer be in your contact.
                                                            </div>
                                                        </div>
                                                    </div>
                                                </a>
                ...
                <div class="tyn-quick-chat-reply js-scroll-to-end">
                    <div class="tyn-reply tyn-reply-quick" id="tynQuickReply">
                        ...
                        <div class="tyn-reply-item outgoing">
                            <div class="tyn-reply-group">
                                <div class="tyn-reply-bubble">
                                    <div class="tyn-reply-text"> Yes, you can reset your password online. Go to the
                                        login page, click on "Forgot Password," and follow the instructions to reset it.
                                    </div><!-- tyn-reply-text -->
                                </div><!-- .tyn-reply-bubble -->
                            </div><!-- .tyn-reply-group -->
                        </div><!-- .tyn-reply-item -->
            ...
            <div class="modal-content border-0">
                <div class="modal-body p-4">
                    ...
                    <ul class="tyn-media-list gap gap-2">
                        ...
                        <li>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="muteFor" id="muteForInfinity"
                                    checked>
                                            ...
                                            <ul class="tyn-list-links">
                                                ...
                                                <li>
                                                    <a href="#videoCallingScreen" data-bs-toggle="modal">
                                                        <!-- camera-video -->
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                                            fill="currentColor" class="bi bi-camera-video"
                                                            viewBox="0 0 16 16">
                                                            <path fill-rule="evenodd"
                                                                d="M0 5a2 2 0 0 1 2-2h7.5a2 2 0 0 1 1.983 1.738l3.11-1.382A1 1 0 0 1 16 4.269v7.462a1 1 0 0 1-1.406.913l-3.111-1.382A2 2 0 0 1 9.5 13H2a2 2 0 0 1-2-2zm11.5 5.175 3.5 1.556V4.269l-3.5 1.556zM2 4a1 1 0 0 0-1 1v6a1 1 0 0 0 1 1h7.5a1 1 0 0 0 1-1V5a1 1 0 0 0-1-1z" />
                                                        </svg>
...
<!-- Mirrored from connectme-html.themeyn.com/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 30 Jul 2024 08:05:54 GMT -->
