                    ...
                    <div class="container">
                        <div class="d-flex align-items-center">
                            <div class="topbar-left">
                                <a href="#" class="text-gray-110 font-size-13 u-header-topbar__nav-link">Welcome to Amazon</a>
                            </div>
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="d-none d-xl-block col-md-auto">
                                <div class="d-flex">
                                    ...
                                    <div class="ml-2">
                                        <div class="phone">
                                            <strong>Support</strong> <a href="tel:1122334455" class="text-gray-90">{{$appData['support']}}</a>
                                        </div>
                                        <div class="email">
                                            E-mail: <a href="xyz@gmail.com?subject=Help Need" class="text-gray-90">{{$appData['email']}}</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
