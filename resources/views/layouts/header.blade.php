                        ...
                        <nav class="js-mega-menu navbar navbar-expand-md u-header__navbar u-header__navbar--no-space">
                            ...
                            <div id="navBar" class="collapse navbar-collapse u-header__navbar-collapse">
                                <ul class="navbar-nav u-header__navbar-nav">
                                    ...
                                    <li class="nav-item u-header__nav-item">
                                        <a class="nav-link u-header__nav-link" href="/chat/chat">Chat </a>
                                    </li>
                                    <!-- End Contact Us -->
                                </ul>
                            </div>
                    ...
                    <div class="d-none d-xl-block col-md-auto">
                        <div class="d-flex">
                            ...
                            <div class="ml-2">
                                ...
                                <div class="email">
                                    E-mail: <a href="mailto:{{$appData['email']}}?subject=Help Need" class="text-gray-90">{{$appData['email']}}</a>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="d-flex">
                            <ul class="d-flex list-unstyled mb-0">
                                ...
                                <li class="col pr-0">
                                    <a href="/shop/cart" class="text-gray-90 position-relative d-flex " data-toggle="tooltip" data-placement="top" title="Cart">
                                        <i class="font-size-22 ec ec-shopping-bag"></i>
                                        <span class="width-22 height-22 bg-dark position-absolute flex-content-center text-white rounded-circle left-12 top-8 font-weight-bold font-size-12"></span>
